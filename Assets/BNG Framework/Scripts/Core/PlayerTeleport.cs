...
namespace BNG
{
    ...
    public class PlayerTeleport : MonoBehaviour
    {
        ...
        public Color ValidTeleport = Color.cyan;
        ...
        {
            setupVariables();
            TeleportBeginTransform = GameObject.Find("TeleportBegin").transform;
            TeleportBeginTransformAlt = GameObject.Find("TeleportBegin").transform;
            TeleportDestination = GameObject.Find("DestTransform").transform;
